...
public class PreguntaDiaria_CN extends Fragment {
    ...
    public void loadDatos() {
        ...
        /*
        Query query = refQuestions.orderByChild("area").equalTo("CN").limitToLast(6);
        ...
        */
        ...
        for(int i = 0; i<=4;i++)
        {
            refQuestions.orderByChild("area").equalTo("CN").addListenerForSingleValueEvent(new ValueEventListener() {
                @Override
                public void onDataChange(DataSnapshot dataSnapshot) {
