...
public class PruebaDiagnostico extends AppCompatActivity {
            ...
            public void onClick(View view) {
                ...
                if (selectedAnswer == 0 && counterQuestion > 0) {
                    ...
                    if (counterQuestion < 0) {
                        ...
                        btnSendAnswer.setBackgroundColor(R.color.colorPrimaryDark);
                        toResults();
    ...
    public void getQuestions(final ArrayList<Question> arrayList) {
        ...
        do {
            ...
            Query query = refQuestions.orderByChild("area").equalTo(listaAreas[countArray]).limitToFirst(6);
            ...
            Toast.makeText(this, "Cargando pregntas de: " + listaAreas[countArray], Toast.LENGTH_SHORT).show();
            countArray--;
            query = null;
