...
public class PreguntaDiaria_IN extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //loadDatos();
        iniciarAdaptador();
        //recyclerView.setBackgroundColor(R.drawable.btn_frag_in);
    ...
    public void loadDatos() {
        ...
        /*
        Query query = refQuestions.orderByChild("area").equalTo("IN").limitToLast(5);
        ...
        */
        for(int i = 0; i<=4;i++)
        {
            refQuestions.orderByChild("area").equalTo("IN").addListenerForSingleValueEvent(new ValueEventListener() {
                @Override
                public void onDataChange(DataSnapshot dataSnapshot) {
